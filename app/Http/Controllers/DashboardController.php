...
class DashboardController extends Controller
{
     ...
     */
    private function visibleDispatches($user): Builder
    {
     ...
     */
    private function visibleProjects($user): Builder
    {
     ...
     */
    private function visibleProgressLogs($user): Builder
    {
     ...
     */
    private function canAny($user, array $capabilities): bool
    {
